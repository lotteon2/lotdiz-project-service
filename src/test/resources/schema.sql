...
;             
CREATE USER IF NOT EXISTS "SA" SALT '79218467dedf01ee' HASH '8110b095ac7ede1baab94422a5c7540e177e72dd1cbde79c8e688902ef486328' ADMIN;         
...
ALTER TABLE "PUBLIC"."support_signature" ADD CONSTRAINT "PUBLIC"."UK_8c2rby4062ugyf5fmay5irlx4" UNIQUE("member_id");          
